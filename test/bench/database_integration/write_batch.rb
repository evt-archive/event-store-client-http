...
context "Write Batch of Events" do
  ...
  read_data_1 = Transform::Read.(body_text_1, EventStore::Client::HTTP::EventData::Read, :json)
  read_data_2 = Transform::Read.(body_text_2, EventStore::Client::HTTP::EventData::Read, :json)
